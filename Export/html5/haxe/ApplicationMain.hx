...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BulletHell", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BulletHell", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "112";
		app.meta["company"] = "CCP";
		app.meta["file"] = "BulletHell";
		app.meta["name"] = "BulletHell";
		app.meta["packageName"] = "me.theaviary.BulletHell";
